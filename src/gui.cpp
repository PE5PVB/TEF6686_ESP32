  ...
  switch (menupage) {
    ...
    case RDSSETTINGS:
      ...
      switch (af) {
        ...
        case 1: tftPrint(1, myLanguage[language][42] + " / REG ON", 310, ITEM6 + 6, PrimaryColor, PrimaryColorSmooth, 16); break;
        case 2: tftPrint(1, myLanguage[language][42] + " / REG OFF", 310, ITEM6 + 6, PrimaryColor, PrimaryColorSmooth, 16); break;
      }
